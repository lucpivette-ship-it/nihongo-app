...
function renderHome() {
  pushView(() => {
    main.innerHTML = `
      ...
      <div class="tile-grid">
        <div class="tile" data-go="kanji"><span class="glyph">漢字</span><span class="label">Kanji</span><span class="sub">Grades 1–5 · 835</span></div>
...
const BUILT_KANJI_GRADES = [1, 2, 3, 4, 5]; // grades with content available so far
const GRADE_KANJI_COUNTS = { 1: 80, 2: 160, 3: 200, 4: 202, 5: 193, 6: 181 };
